...
public class RangerEmptyAccessController implements AccessController {
    ...
    @Override
    public void checkTableAction(UserIdentity currentUser, Set<Long> roleIds, TableName tableName,
                                 PrivilegeType privilegeType) {
