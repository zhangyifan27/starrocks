...
public interface ProfilePlugin {
    ...
    /**
     * use for check profile event type, the event will skip the plugin if return false
     */
    boolean eventFilter(ProfileEvent.EventType type);
