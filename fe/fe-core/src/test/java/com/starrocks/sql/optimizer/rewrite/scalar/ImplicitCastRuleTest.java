...
public class ImplicitCastRuleTest {
    ...
    public void testDateColumnWithCastExpression() {
        ...
        ColumnRefOperator dateColumn = new ColumnRefOperator(1, Type.DATE, "dt", true);
        CastOperator castExpression = new CastOperator(Type.BIGINT, ConstantOperator.createBigint(20250101));
        ...
        // The result should be optimized: dt = '2025-01-01'
        ...
        assertEquals(Type.DATE, resultPredicate.getChild(0).getType());
        assertTrue(resultPredicate.getChild(1) instanceof ConstantOperator);
        assertEquals(Type.DATE, resultPredicate.getChild(1).getType());
