...
public class StatisticsCollectJobTest extends PlanTestNoneDBBase {
    ...
    public void testAnalyzeHistogram() {
        ...
        Assert.assertEquals(String.format("INSERT INTO histogram_statistics(table_id, column_name, db_id, table_name, " +
                        "buckets, mcv, update_time) SELECT 10011, 'v2', 10009, 'test.t0_stats', " +
        ...
        Assert.assertEquals(String.format("INSERT INTO histogram_statistics(table_id, column_name, db_id, table_name," +
                " buckets, mcv, update_time) SELECT 10011, 'v4', 10009, 'test.t0_stats', " +
        ...
        Assert.assertEquals("INSERT INTO histogram_statistics(table_id, column_name, db_id, table_name," +
                " buckets, mcv, update_time) SELECT 10011, 'v5', 10009, 'test.t0_stats', " +
                "histogram(`column_key`, cast(64 as int), cast(0.1 as double)),  " +
    ...
    public void testExternalAnalyzeAllDb() {
        ...
        List<StatisticsCollectJob> jobs = StatisticsCollectJobFactory.buildExternalStatisticsCollectJob(
                new ExternalAnalyzeJob("hive0", null, null, null, null,
                        ...
                        StatsConstants.ScheduleStatus.PENDING,
                        LocalDateTime.MIN));
        Assert.assertEquals(33, jobs.size());
    }
